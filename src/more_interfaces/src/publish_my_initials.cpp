...
// Create a node and an Initials publisher.
  ...
  : Node("my_initials_publisher")
  {
    my_initials_publisher_ =
      this->create_publisher<more_interfaces::msg::MyName>("my_initials", 10);

    // Create a callback to publish the messages periodically.
    auto publish_msg = [this]() -> void {
        auto message = more_interfaces::msg::MyName();
...
private:
  rclcpp::Publisher<more_interfaces::msg::MyName>::SharedPtr my_initials_publisher_;
